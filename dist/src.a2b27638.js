...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/Monitor.js":[function(require,module,exports) {
"use strict";
...
var Monitor = /*#__PURE__*/function () {
  ...
  _createClass(Monitor, [{
    ...
    value: function setPixel(x, y) {
      ...
      if (x > this.cols) x -= this.cols;else if (x < 0) x += this.cols;
...
var monitor = new _Monitor.default(document.getElementById("screen"));
monitor.testRender();
},{"./Monitor":"src/Monitor.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
